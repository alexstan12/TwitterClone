...
public class UserController {
    ...
    public String registration(@RequestBody User userFromRequest){
...
/*
    ...
    public String follow(@PathVariable Long userId, @RequestBody FollowForm followForm){

        return "Followed user with id: " +  userService.addFolloweeForUser(userId, followForm.getFolloweeId());
